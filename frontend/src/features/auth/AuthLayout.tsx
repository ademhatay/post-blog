...
const AuthLayout = ({ title, children }: AuthLayoutProps) => {
  ...
  return (
    <div className="min-h-screen w-full flex flex-col md:flex-row">
      <div
        className="md:flex-[2] text-white flex flex-col items-center justify-center p-8 relative"
      ...
      <div className="md:flex-1 bg-white flex items-center justify-center p-6">
